...
4. 摘要要求: 3-5句话核心内容，100-200 中文字符
5. 分析要求: 3-5句话核心内容，100-200 中文字符
...
2. [x] 逐条处理文章：获取内容、判断分类(宏观经济/国家政策/地缘政治)、生成摘要(3-5句,100-200字)、生成分析(3-5句,100-200字)
...
2. [x] 逐条处理文章：获取内容、判断分类、生成摘要(3-5句,100-200字)、生成分析(3-5句,100-200字)
3. [x] 保存结果到 `news/data/2026-01-25.json`，格式符合规范

### Phase 4: 生成报告
1. [x] 输出处理统计：总天数、总文章数、各类别数量、失败列表(如有)
  ...
  "articles": [
    {
      ...
      "summary": "中文摘要，3-5句核心内容，100-200字",
      "analysis": "中文市场影响分析，3-5句核心内容，100-200字"
    }
  ]
}
```
...
格式示例: "该新闻对科技股构成利好，预计将推动纳斯达克指数上涨。由于市场风险偏好提升，资金可能从债市流出，导致美债收益率上行。美元指数或因经济前景改善而走强，黄金作为避险资产的吸引力可能下降。"
